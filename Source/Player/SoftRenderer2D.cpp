...
float currentDegree = 0.f; // 각도법을 사용한 회전 각 저장
...
void SoftRenderer::Update2D(float InDeltaSeconds)
{
	...
	static float rotateSpeed = 180.f; // 각속도
...
void SoftRenderer::Render2D()
{
	...
	Math::GetSinCos(sin, cos, currentDegree); // 각도법으로 표현된 회전각에서 sin값과 cos값을 계산하여 저장하는 함수
